...
<el-form ref="form" :model="form" label-width="80px">
  <el-form-item label="活动名称" label-suffix="我是这个字段的描述信息">
...
```html
<el-form  label-position="top" :model="dynamicValidateForm" ref="dynamicValidateForm" label-width="100px" class="demo-dynamic">
  <el-form-item  label-position="left" prop="email" label="邮箱11" required required-count="4" required-message="自定义提示">
